...
class Tela_Depositar(object):
    ...
    '''
     Classe Tela_Depositar vai representar nossa opção de mostrar a tela de deposito, tendo parâmetro um objeto
                ...
    ...
    def setupUi(self, MainWindow):
        ...
        '''
        Configurando os parâmetros da nossa janela princial a nossa tela da opção deposito
                ...
...
"background-color: rgb(10, 10, 10);")
        ...
        self.pushButton_Depositar = QtWidgets.QPushButton(self.register_area)
        self.pushButton_Depositar.setGeometry(QtCore.QRect(180, 430, 280, 50))
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(220, 0, 161, 61))
        font = QtGui.QFont()
...
"    color: rgb(100, 100, 100);")
        ...
        self.lineEdit_valor = QtWidgets.QLineEdit(self.register_area)
        self.lineEdit_valor.setGeometry(QtCore.QRect(180, 310, 281, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
...
"}")
        ...
        self.lineEdit_cliente.setGeometry(QtCore.QRect(50, 150, 113, 20))
...
"}")
        ...
        self.label_cliente.setGeometry(QtCore.QRect(0, 150, 47, 13))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        sendo nossa janela principal da nossa opção de mostrar a tela deposito
