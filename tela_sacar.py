...
class Tela_Sacar(object):
    ...
    '''
    Classe Tela_Sacar vai representar nossa opção saque, tendo parâmetro o objeto
        ...
    ...
    def setupUi(self, MainWindow):
        ...
        '''
        Configurando os parâmetros da nossa janela principal a nossa tela da opção de sacar
                ...
...
"}")
        ...
        #
        self.lineEdit_Versal = QtWidgets.QLineEdit( self.register_area )
        self.lineEdit_Versal.setGeometry( QtCore.QRect( 360, 95, 100, 30 ) )
        font = QtGui.QFont()
        font.setPointSize( 15 )
        self.lineEdit_Versal.setFont( font )

        self.lineEdit_Versal.setStyleSheet( "QLineEdit {\n"
                                           "    border: 2px solid rgb(45, 45, 45);\n"
                                           "    border-radius: 5px;\n"
                                           # "    padding: 35px;\n"
                                           "    background-color: rgb(30, 30, 30);    \n"
                                           "    color: rgb(100, 100, 100);\n"
                                           "}\n""}" )
        self.lineEdit_Versal.setObjectName( "lineEdit_Versal" )
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        sendo nossa janela principal da nossa opção de mostrar tela de saque
